...
//        }
        ...
        val fragment = FitnessFragment.newInstance()
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            R.id.nav_fitness ->
                navigateTo(FitnessFragment.newInstance())
            R.id.nav_report ->
    ...
    override fun onRequestPermissionsResult(requestCode: Int, permissions: Array<String>, grantResults: IntArray) {
        ...
        Log.v("Fitness", "Home LAT: ${app.currentLocation.latitude} LNG: ${app.currentLocation.longitude}")
    }
}
