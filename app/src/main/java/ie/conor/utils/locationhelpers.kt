...
fun setCurrentLocation(app: FitnessApp) {
...
@SuppressLint("MissingPermission")
fun trackLocation(app: FitnessApp) {
...
fun setMapMarker(app: FitnessApp) {
    ...
    app.database.child("user-fitnessx").child(app.auth.currentUser!!.uid)
        .addValueEventListener(object : ValueEventListener {
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                addMapMarkers(fitnessxList, app.mMap)
            }
        })
...
fun addMapMarkers(dl : ArrayList<FitnessModel>, map: GoogleMap) {
    dl.forEach {
        map.addMarker(
